...
const GAMES = [
  ...
  { id: 'sl' as GameId, name: 'Sortl',            description: 'Sort the tubes by colour',             url: 'https://sortl.stoop.games',        emoji: '🧪' },
]
...
export default function RotatingAlsoPlay({ from = 'bl' as GameId }: { from?: GameId }) {
